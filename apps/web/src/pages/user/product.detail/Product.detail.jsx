                ...
                <div className="mt-2 sm:mt-8">
                  ...
                  <div className="mt-8 w-10/12 text-gray-500 text-[14px]">
                    ...
                    <ul>
                      ...
                      <li>
                        2. Setelah barang diterima, pastikan pesanan Anda sesuai
                        dan video
                      </li>
                      <li>
                        3. Jika barang tidak sesuai atau bermasalah segera
                        hubungi melalui email acewarehose@gmail.com
                      </li>
                    </ul>
                  </div>
                  {/* Checkout Secction : Mas Rama */}
